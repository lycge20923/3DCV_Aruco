...
if __name__ == '__main__':
    ...
    parser.add_argument('--width',dest='width',help="the scale of square in one side", type=int, default=3)
    parser.add_argument('--height',dest='height',help="the scale of square in another side",type=int, default=3)
